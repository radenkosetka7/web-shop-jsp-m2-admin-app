...
<a style="font-size: 18px; float: right; margin-top: -15px; margin-right: 30px" href="?action=users">Users</a>
<a style="font-size: 18px; float: right; margin-top: -15px; margin-right: 20px" href="?action=logs">Logs</a>
